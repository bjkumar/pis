...
<html lang="en">
    <head>
        ...
        <script>
            ...
            var myid = '<?php echo $this->session->userdata('user_id'); ?>';
        </script>
    ...
    <body class="nav-md">
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <?php echo '<img src="' . SITE_URL . 'asset/images/profile_pic/' . $this->session->userdata('pro_image') . '" alt="..." class="img-circle profile_img" id="pro_img">';
                                ?>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                                ...
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-home"></i> User <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <li><a onclick='httpPageGet("<?php echo SITE_URL; ?>user/Ctl_user/user_profile")'>My Profile</a></li> 
                                          <!--<li><a href="<?php echo SITE_URL; ?>admin/Ctl_admin/user_list">User List</a></li>-->
                                          <!--  <i class="fa fa-clone"></i>                                       <li><a href="index2.html">Dashboard2</a></li>
                                                                                  <li><a href="index3.html">Dashboard3</a></li>-->
                                        </ul>
                                    </li>
                                   <li> <a onclick='httpPageGet("<?php echo SITE_URL; ?>user/Ctl_user/add_account")'><i class="fa fa-plus-square-o"></i>  Add New Account </a></li>   
                                    <!--<li> <a href="<?php echo SITE_URL; ?>user/Ctl_user/add_account"><i class="fa fa-plus-square-o"></i>  Add New Account </a></li>-->
                                    ...
                                    <li><a onclick='httpPageGet("<?php echo SITE_URL; ?>Ctl_common/my_organization/employee")'><i class="fa fa-sun-o" aria-hidden="true"></i> My Organization</a></li> 
                            ...
                            <!-- right chat box-->
                            <div id="chat-box" class="add-chat-list-user">

                                <!--                            <div class="chat-box-row">
                                                                 <span class="recvr_img_chat">
                                                                        <img src="http://localhost:8080/tpis/asset/images/profile_pic/1523438592.jpg" style="width:33px;height:35px;"></span>
                                                                  <div>Binod<span class="online_green">&nbsp;&nbsp;</span></div>
                                                            </div>  -->
                        ...
                        <div class="sidebar-footer hidden-small">
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?php echo SITE_URL; ?>user/Ctl_user/user_logout">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        <li><a href="<?php echo SITE_URL; ?>user/Ctl_user/user_logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                                    </ul>
                                </li>
                                <!-- birthday -->
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick="return ChangePasswordUser(event);" style="width: 177px;">Update</button>
                            </div>
      ...
      <!--  <script src="<?php echo SITE_URL; ?>asset/js/moment/moment.min.js"></script>
        ...
        <!--<script src="<?php echo SITE_URL; ?>asset/js/moment/min/moment.min.js"></script>--> 
        ...
        <!--<script src="<?php echo SITE_URL; ?>asset/javascript/page_control.js"></script>-->
        <!-- date picker js &select search dropdown js -->
        ...
        <script type="text/javascript">
            ...
            function GoPageInitialize(mysitePath) {
                ...
                GetTGramList();
                LoadPM();
                if ((window.location.href.indexOf("Ctl_common/edit_list") > -1) || (window.location.href.indexOf("Ctl_common/plp_list") > -1) || (window.location.href.indexOf("Ctl_common/rpm_list") > -1)) {
                    $('#example').dataTable({
                        "order": [],
                    });
                    ...
                    AddAccountFooterJs(); // => common_function.js
                ...
                /*
                 ...
                 $('#select-pm').hierarchySelect({hierarchy: false});
                 */
                $('.please_wait').hide();
