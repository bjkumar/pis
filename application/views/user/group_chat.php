...
<!--                                        <p class="lead emoji-picker-container">
    <textarea style="background-color: #fcfeff;" class="form-control textarea-control" name="chat_message" id="chat_message"  rows="3" placeholder="Chat Here with emoji Unicode input" data-emojiable="true" data-emoji-input="unicode"></textarea>
                                            ...
                                            <input type="hidden" name="sender_id" id="sender_id" value="<?php echo $this->session->userdata('user_id'); ?>">
                                            <input type="hidden" name="sender_name" id="sender_name" value="<?php echo $this->session->userdata('fname'); ?>">
                                            <input type="hidden" name="sender_img" id="sender_img" value="<?php echo $this->session->userdata('pro_image'); ?>">
