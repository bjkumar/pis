                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form name="edit_form" id="edit_form" data-parsley-validate="" class="mbr-form" novalidate="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control OnlyNum" name="cid_plp" value="<?php echo $list['cid']; ?>" <?php echo $disabled; ?>>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group"><label class="form-control-label" for="re_assign_date">Re-Assigned: (DD/MM/YY H:M) </label>
                                            <div class="input-group date" id="myDatepicker_re_assign">
                                                <input type="text" class="form-control" name="re_assign_date" id="re_assign_date" value="<?php echo $list['re_assigned_date']; ?>" disabled>
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="billing_hour" id="billing_hour" type="text" required="required" value="<?php echo $list['billing_hour']; ?>" <?php echo $disabled; ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="qc_hour" id="qc_hour" type="text" required="required" value="<?php echo $list['qc_hour']; ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="actual_hour" id="actual_hour" type="text" required="required" value="<?php echo $list['actual_hour']; ?>" disabled>
                                        </div>
                                    </div> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="error_details_plp" id="error_details_plp" type="text" value="<?php echo $list['error_details_plp']; ?>" <?php echo $disabled; ?>>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="ed_no_of_edits" id="ed_no_of_edits" type="text" value="<?php echo $list['no_of_edits']; ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="ed_no_of_errors" id="ed_no_of_errors" type="text" value="<?php echo $list['no_of_errors']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label class="form-control-label" for="ed_qc_score">QC Score</label>
                                            <input class="form-control read_only" name="ed_qc_score" id="ed_qc_score" type="text" value="<?php echo $list['qc_score']; ?>" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if ($list['tl_id'] < 1) { ?> 
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-primary btn-form display-4" onclick="UpdatePLPDetailsUser(event);">Update</button>
                                    </span> 
                                <?php } ?> 
