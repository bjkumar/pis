...
if ($this->session->userdata('user_id_qc') != '') {
     redirect(SITE_URL . 'tl/Ctl_user/qc_user_profile');
}
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>TL Log in |  Technosoft Engineering Projects Ltd. </title>
        <script>
        ...
        <script src="<?php echo SITE_URL; ?>asset/javascript/validate_tl.js"></script>  
         <script src="<?php echo SITE_URL; ?>asset/javascript/validate_qc.js"></script> 
                ...
                <div class="animate form login_form">
                    <section class="login_content">
                        <form name="login_frm" id="login_frm">
                            ...
                            <div>
                                <button class="btn btn-default submit" type="submit" value="Log in" name="" onclick="return ChkMemloginQC(event);" tabindex="3">Login</button>
