                        ...
                        <div class="x_content">
                            ...
                            <form name="rpm_form" id="rpm_form" data-parsley-validate="" class="mbr-form" novalidate="">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control rpm_request_type"  name="rpm_request_type" onchange="Put_R_Type_id_days(this.value);"> 
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group"><label class="form-control-label" for="rpm_received_date">Received Date: (DD/MM/YY) <span class="required">*</span></label>
                                            <div class="input-group date" id="myDatepicker_rpm">
                                                <input type="text" class="form-control" name="rpm_received_date" id="rpm_received_date" value="<?php echo $list['received_date']; ?>">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="ed_t_id" id="t_id1" type="text" value="<?php echo $list['tgram_id']; ?>" maxlength="8">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="cid_rpm" id="cid_rpm" type="text" maxlength="5" value="<?php echo $list['cid']; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="program_rpm" id="program_rpm" required="">
                                                <option value="">-- Select --</option> 
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="queries" onchange="CheckResolutionDate(this.value);">
                                                <option value="">-- Select --</option>
                                    ...
                                    <div class="col-md-2 resol_date" <?php echo $res_dt_show; ?>>
                                        <div class="form-group"><label class="form-control-label" for="rpm_resolution_date">Resolution Date: (DD/MM/YY) *</label>
                                            <div class="input-group date" id="resolution_date">
                                                <input type="text" class="form-control" name="rpm_resolution_date" id="rpm_resolution_date" value="<?php echo $list['resolution_date']; ?>">
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div> 
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="no_of_pages" type="number" required="required" value="<?php echo $list['no_of_pages']; ?>" maxlength="3">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="billing_hour_rpm" id="billing_hour_rpm" type="text" required="required" value="<?php echo $list['billing_hour']; ?>" maxlength="3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="qc_hour_rpm" id="qc_hour_rpm" type="text" required="required" value="<?php echo $list['qc_hour']; ?>" maxlength="3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="actual_hour_rpm" id="actual_hour_rpm" type="text" required="required" value="<?php echo $list['actual_hour']; ?>" maxlength="3">
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group"><label class="form-control-label" for="rpm_start_date">Start Date: (DD/MM/YY) *</label>
                                            <div class="input-group date" id="rpm_start_datepicker">
                                                <input class="form-control" name="rpm_start_date" id="rpm_start_date" onkeydown="event.preventDefault()" type="text" value="<?php echo $list['start_date']; ?>">
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="rpm_datepicker">
                                                <input type="text" class="form-control" name="rpm_date_delivered" id="rpm_date_delivered" value="<?php echo $list['delivered_on']; ?>">
                                                <span class="input-group-addon">
                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="url" id="url" value="<?php echo $list['url_rpm']; ?>">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="remark" id="remark" type="text" value="<?php echo $list['remark']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-control-label" for="final_qc_score">QC (in %) *</label>
                                             <input class="form-control OnlyNum" maxlength="5" name="qc_score" id="qc_score" type="text" value="<?php echo $list['qc_score']; ?>">
                                         </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    ?>
                                                    <input type="checkbox" <?php echo $check_uncheck; ?> class="form-control-label help_checkbox" value="1"> 
                                    ...
                                    <span class="helper_div" <?php echo $style_hide; ?>>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control OnlyNum" name="emp_hour" id="emp_hour" value="<?php echo $list['helper_hour']; ?>" maxlength="3">
                                            </div>
                                        </div> 
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-primary btn-form display-4" onclick="UpdateRPMDetailsQC(event);">Update</button>
                                </span> 
                            </form>
