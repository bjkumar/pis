    ...
    <body class="nav-md">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div class="sidebar-footer hidden-small">
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?php echo SITE_URL; ?>tl/Ctl_user/user_logout">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        ...
                                        <li><a href="<?php echo SITE_URL; ?>tl/Ctl_user/user_logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                                    </ul>
                                </li>
        ...
        <script type="text/javascript">
                                    ...
                                    function GoPageInitialize(mysitePath) {
                                        ...
                                        $("#from_date_report").datetimepicker({format: 'DD/MM/YYYY HH:mm', maxDate: new Date()});
                                        $("#to_date_report").datetimepicker({format: 'DD/MM/YYYY HH:mm', maxDate: new Date()});
                                    }
