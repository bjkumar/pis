                        ...
                        <div class="x_content">
                            ...
                            <form name="rpm_form" id="rpm_form" data-parsley-validate="" class="mbr-form" novalidate="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="billing_hour_rpm" id="billing_hour_rpm" type="text" required="required" value="<?php echo $list['billing_hour']; ?>" maxlength="5">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="qc_hour_rpm" id="qc_hour_rpm" type="text" required="required" value="<?php echo $list['qc_hour']; ?>" maxlength="4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control OnlyNum" name="actual_hour_rpm" id="actual_hour_rpm" type="text" required="required" value="<?php echo $list['actual_hour']; ?>" maxlength="6">
                                        </div>
                                    </div> 
                                ...
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-primary btn-form display-4" onclick="UpdateRPMDetails(event);">Update</button>
                                </span> 
                            </form>
