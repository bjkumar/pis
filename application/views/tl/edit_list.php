                               ...
                               <!-- between dates report --> 
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group"><label class="form-control-label" for="to_date_report">To:(D/M/Y H:M)*</label>
                                         ...
                                         <input name="category" value="EDIT" type="hidden">
                                    <div class="col-md-2" style="margin-top: 5%;">
                                        <span class="input-group-addon" style="" onclick="GetReportsBetweenDates('EDIT')">
                                                    GO
                                       </span>
                                    </div>
                                   </form>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo SITE_URL; ?>Ctl_reports/excel_edit_all">Download Excel File</a>
                                        </li>
