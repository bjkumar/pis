                    ...
                    <div class="x_content">
                        ...
                        <form name="atype_frm"  id="atype_frm" class="form-horizontal" >
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-2" for="at_name">Account Type PLP:
                                </label>
                                <div class="col-xs-3">
                                    <input type="text" name="field_val" required="required" class="control-label col-md-12 col-sm-12 col-xs-12" style="text-align: left;">
                                    <input type="hidden" name="field_name" value="account_type">
                                    <input type="hidden" name="table_name" value="account_type_plp">
                                </div>
                                <div class="col-xs-3">
                                    <button type="button" class="btn btn-success" onclick="Standerd_Save(event);">Save Account Type</button> 
                                </div>
                            </div>
                            <div class="form-group">
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form name="update_frm" id="update_frm">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="actype_upd">Account Type PLP<span class="required">*</span>
                        </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <input type="text" name="field_val_up" id="field_val_up" class="form-control col-md-7 col-xs-12">
                                <input type="hidden" name="field_name_up" id="field_name_up" value="account_type">
                            <input type="hidden" name="table_name_up" value="account_type_plp">
...
<script>
    ...
    function DeleteAccount(id) {
        ...
        if (agree)
        {
            window.location.href = SITE_URL + "admin/Ctl_admin/account_type_plp/" + id;
        } else {
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                 if (data == 1) {
                    ...
                    setTimeout(function () {
                        $('.please_wait').hide();
                        window.location.href = SITE_URL + "admin/Ctl_admin/account_type_plp";
                    }, 1200);
